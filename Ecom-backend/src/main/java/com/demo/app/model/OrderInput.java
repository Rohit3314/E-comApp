...
public class OrderInput {
	...
	private java.util.List<OrderProductQuantity> orderProductQuantityList;
	...
	public java.util.List<OrderProductQuantity> getOrderProductQuantityList() {
		return orderProductQuantityList;
	}
	public void setOrderProductQuantityList(java.util.List<OrderProductQuantity> orderProductQuantityList) {
		this.orderProductQuantityList = orderProductQuantityList;
	}
