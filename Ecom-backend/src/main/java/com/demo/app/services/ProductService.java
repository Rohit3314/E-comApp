...
public class ProductService {
	...
	public List<Product>getAllProducts(int pageNumber,String searchKey){
		Pageable pagable =PageRequest.of(pageNumber, 8);
		if(searchKey.equals("")) {
			return	(List<Product>) productDao.findAll(pagable);
		}else {
			return (List<Product>) productDao.findByProductNameContainingIgnoreCaseOrProductDescriptionContainingIgnoreCase(searchKey, searchKey, pagable);
		}
